...
const scanConfig = {
  xray: {
    ...
    annotations: [],
    findings: [
      { label: 'Cortical Margins', detail: 'Intact alignment. No acute fracture line.', s: 'ok' },
      { label: 'Joint Spaces', detail: 'Preserved alignment bilaterally.', s: 'ok' },
      { label: 'Soft Tissue Outline', detail: 'Normal soft tissue density.', s: 'ok' },
      { label: 'Trabecular Pattern', detail: 'Homogeneous bone mineral density.', s: 'ok' },
    ],
    prompt: 'Analyze this X-ray image in detail. Identify the anatomical region (hand, wrist, limb, joint, or chest), evaluate bone alignment, joint spaces, soft tissues, and any abnormalities. Provide a detailed diagnostic report.',
  },
  mri: {
    ...
    annotations: [],
    findings: [
      { label: 'Tissue Contrast', detail: 'Normal T1/T2 signal intensity.', s: 'ok' },
      { label: 'Anatomical Structure', detail: 'Intact anatomical continuity.', s: 'ok' },
      { label: 'Soft Tissue Signal', detail: 'No focal mass or acute edema.', s: 'ok' },
      { label: 'Structural Alignment', detail: 'No mass effect or midline shift.', s: 'ok' },
    ],
    prompt: 'Analyze this MRI scan in detail. Identify the anatomical region, evaluate soft tissues, signal intensity, and any abnormalities. Provide a detailed diagnostic report.',
  },
  ct: {
    ...
    annotations: [],
    findings: [
      { label: 'Cross-Sectional Density', detail: 'Homogeneous attenuation values.', s: 'ok' },
      { label: 'Bony Structures', detail: 'Intact cortical boundaries.', s: 'ok' },
      { label: 'Vascular / Organ Contours', detail: 'Normal size and structural contours.', s: 'ok' },
      { label: 'Pathology Screening', detail: 'No acute hemorrhage or mass lesion.', s: 'ok' },
    ],
    prompt: 'Analyze this CT scan in detail. Identify the anatomical region, evaluate cross-sectional density, organ contours, and any abnormalities. Provide a detailed diagnostic report.',
  },
};
